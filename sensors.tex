...
How much is it possible to classify and implement a P300 ERP Speller using only the waveform structure of the signal ? Which algorithm perform better at this even when single trial latency variations and component amplitudes issues are present ?
...
The methods \textit{SIFT} and \textit{SHCC} performed much better than the other algorithms including when the latency and the amplitudes are noisy.
