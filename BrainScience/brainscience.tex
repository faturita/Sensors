...
\caption{\textbf{Passive Modality - Experiment 2}: Performance curves for four subjects for the five algorithms when a random latency is included when superimposing the P300 signal template.}
\label{fig:1-2}
\end{figure}
...
\caption{\textbf{Active Modality - Experiment 2}: Performance curves for the four subjects for the five algorithms.  A random latency is included while superimposing the P300 signal template.}
\label{fig:2-2}
\end{figure}
