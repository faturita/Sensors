...
Once templates are procured, a random \textit{False} segment for the same subject is obtained.  This is used as a baseline signal and is added to the template, conforming a new segment which contains one of the templates.  This procedure continues until the $700$ segments marked as \textit{True} are completed.  
