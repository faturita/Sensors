...
\begin{quotation}
{\color{blue}
Thank you for your comments and for this high quality and detailed review.  We have modified several points according to your recommendations. We hope the article is now better suited for publication. 
}
\end{quotation}
%
\vskip+1ex
...
Absolutely thank you very much for providing 
...
We have modified the text highlighting the connections with the information provided in this table and rearranged the way the information was being shown.
...
\begin{quotation}
{\color{blue}
We have included the best/worst channel which is much better for the understanding of the performance obtained for the algorithm.
We have modified the captions of the tables and figures, thank you very much for raising this issue.
...
\begin{quotation}
{\color{blue}
Studies on this dataset reported performance values of perfect classification though they used handcrafted algorithms aimed to this dataset.
}
\end{quotation}
%
\vskip+1ex
